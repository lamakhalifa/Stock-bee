...
@section('content')
        ...
        <div class="login-page-wrapper">
                ...
                <div class="sidebar-content-wrapper">
                    ...
                    <div class="login-logo-container">
                        ...
                        <h1 class="login-main-title title-slide-in">
                            إعادة تعيين <span class="login-main-title-accent">كلمة المرور</span>
                        </h1>
                        <p class="login-description-text text-fade-in">
                            أدخل كلمة مرور جديدة لحسابك في نظام STOCK-BI
                        </p>
                    </div>
                    ...
                    <div class="login-features-container">
                        <div class="login-feature-card feature-slide-in" style="animation-delay: 0.2s">
                            ...
                            <div class="login-feature-details">
                                <h4>أمان عالي المستوى</h4>
                                <p>نظام تشفير متقدم لحماية بياناتك</p>
                            </div>
                        </div>
                        ...
                        <div class="login-feature-card feature-slide-in" style="animation-delay: 0.4s">
                            ...
                            <div class="login-feature-details">
                                <h4>حماية متميزة</h4>
                                <p>نضمن سرية وأمان معلوماتك الشخصية</p>
                            </div>
                        </div>
            ...
            <div class="login-form-panel">
                ...
                <div class="login-form-container">
                    <!-- رأس إعادة تعيين كلمة المرور مع أنيميشن -->
                    <div class="login-form-header">
                        <h2 class="title-bounce">تعيين كلمة مرور جديدة</h2>
                        <p class="login-form-subtitle text-typing">أدخل كلمة المرور الجديدة مرتين للتأكيد</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.update') }}" id="resetPasswordForm"
                        ...
                        <!-- حقل كلمة المرور الجديدة مع أنيميشن -->
                        <div class="login-form-group form-group-slide-in" style="animation-delay: 0.3s">
                            <label for="reset-password" class="login-input-label label-float">
                            ...
                            <div class="login-input-wrapper input-float">
                                ...
                                <button type="button" class="login-password-toggle" id="resetPasswordToggle">
                        ...
                        <div class="login-form-group form-group-slide-in" style="animation-delay: 0.5s">
                            <label for="reset-password-confirm" class="login-input-label label-float">
                                <i class="fas fa-lock icon-float"></i>
                                تأكيد كلمة المرور
                            </label>
                            <div class="login-input-wrapper input-float">
                                ...
                                <button type="button" class="login-password-toggle" id="resetPasswordConfirmToggle">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <div class="login-input-icon">
                                    <i class="fas fa-check-circle"></i>
                        ...
                        <div class="password-strength-container form-group-slide-in" style="animation-delay: 0.7s">
                        ...
                        <!-- زر إعادة تعيين كلمة المرور مع أنيميشن -->
                        <button type="submit" class="login-submit-button pulse-glow">
                            <span class="login-button-text">تعيين كلمة المرور</span>
                            <i class="fas fa-redo login-button-icon icon-bounce"></i>
                        </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const resetPasswordConfirmField = document.getElementById('reset-password-confirm');

            if (resetPasswordToggle && resetPasswordField) {
                resetPasswordToggle.addEventListener('click', function() {
                    const type = resetPasswordField.getAttribute('type') === 'password' ? 'text' :
                        'password';
            ...
            if (resetPasswordConfirmToggle && resetPasswordConfirmField) {
                resetPasswordConfirmToggle.addEventListener('click', function() {
                    const type = resetPasswordConfirmField.getAttribute('type') === 'password' ? 'text' :
                        'password';
                    resetPasswordConfirmField.setAttribute('type', type);
                    this.innerHTML = type === 'password' ? '<i class="fas fa-eye"></i>' :
                        '<i class="fas fa-eye-slash"></i>';
                });
            }
            ...
            if (passwordField && strengthBar && strengthText) {
                passwordField.addEventListener('input', function() {
                    ...
                    const confirmField = document.getElementById('reset-password-confirm');
                ...
                function checkPasswordMatch() {
                    ...
                    const confirmIcon = document.querySelector(
                        '.login-input-wrapper:has(#reset-password-confirm) .login-input-icon i');
